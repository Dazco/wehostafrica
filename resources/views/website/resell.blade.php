...
@section('part-header')
    <div class="container wow fadeIn py-5" id="head_notez">
        <h1 class="hh2 text-primary pt-2 font-weight-bold text-shadow wow fadeIn" data-wow-delay="1s">Reseller Hosting Services</h1>
        <h6 class="wow fadeIn" data-wow-delay="1s">Join over 200 resellers using our platform, Pay for what you actually use. No hidden charge!</h6>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <section class="container-fluid py-3 list_sec w3-section wow fadeIn" data-wow-delay="1s">
                            ...
                            <h5><b>$20 / Year</b></h5>
                            <h6><small>Start as a reseller</small></h6>
                            ...
                            <div class="container-fluid w3-section">
                                <a href="https://www.wehostafrica.com/clients/cart.php?a=add&pid=6" class="btn btn-lg btn-outline-warning"><b>Choose Plan</b></a>
                            </div>
                        </section>
                    </div>
                    <!--  -->
                    <div class="col-md-3 col-sm-6">
                        <section class="container-fluid py-3 list_sec w3-section def wow fadeIn" data-wow-delay="1s">
                            <h4 class="text-primary"><b>Reseller 2</b></h4>
                            <h5><b>$30 / Year</b></h5>
                            <h6><small>More space & unlimited</small></h6>
                            <hr class="border-warning d-inline-block p-0 text-center" style="width: 50px;">
                            <div class="container-fluid w3-section px-0 pt-3 pb-3">
                                <h6 class="pb-1"><strong class="text-dark">Features</strong></h6>
                                <p class="m-0 my-1">
                            ...
                            <div class="container-fluid w3-section">
                                <a href="https://www.wehostafrica.org/clients/cart.php?a=add&pid=7" class="btn btn-lg btn-outline-warning"><b>Choose Plan</b></a>
                            </div>
                        </section>
                    </div>
                    <!--  -->
                    <div class="col-md-3 col-sm-6">
                        <section class="container-fluid py-3 list_sec w3-section wow fadeIn">
                            ...
                            <h5><b>$40 / Year</b></h5>
                            <h6><small>Great Service and Unlimited</small></h6>
                            <hr class="border-warning d-inline-block p-0 text-center" style="width: 50px;">
                            <div class="container-fluid w3-section px-0 pt-3 pb-3">
                                <h6 class="pb-1"><strong class="text-dark">Features</strong></h6>
                                <p class="m-0 my-1">
                            ...
                            <div class="container-fluid w3-section">
                                <a href="https://www.wehostafrica.com/clients/cart.php?a=add&pid=8" class="btn btn-lg btn-warning"><b>Choose Plan</b></a>
                            </div>
                        </section>
                    </div>
                    <!--  -->
                    <div class="col-md-3 col-sm-6">
                        <section class="container-fluid py-3 list_sec w3-section wow fadeIn" data-wow-delay="2s">
                            ...
                            <h5><b>$50 / Year</b></h5>
                            <h6><small>Enjoy Unlimited Bandwidth</small></h6>
                            <hr class="border-warning d-inline-block p-0 text-center" style="width: 50px;">
                            <div class="container-fluid w3-section px-0 pt-3 pb-3">
                                <h6 class="pb-1"><strong class="text-dark">Features</strong></h6>
                                <p class="m-0 my-1">
                            ...
                            <div class="container-fluid w3-section">
                                <a href="https://www.wehostafrica.com/clients/cart.php?a=add&pid=9" class="btn btn-lg btn-outline-warning"><b>Choose Plan</b></a>
                            </div>
                        </section>
                    </div>
                    <!--  -->
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <p class="pt-3 w3-medium">
                            All of our web hosting services are backed up by our pioneering Hosting Guarantee. This guarantee is a mark of the high quality that you expect of WEHOSTAFRICA and underlines our commitment to providing excellence in our hosting division.
                        </p>
                    </div>
                            ...
                            <section class="container-fluid px-0 w3-section">
                                <div class="card">
                                    ...
                                    <div id="ques1" class="collapse" role="tabpanel" aria-labelledby="headingOne" data-parent="#accordion">
                                        <div class="card-body">
                                            Reseller hosting is a platform that allows you to sell hosting plans to other people. You can create your own hosting packages and sell to people at your own price.
                                        </div>
                                    </div>
                                </div>
                            </section>
