...
@section('part-header')
    ...
    <section class="container-fluid bg-primary py-5">
        <div class="container px-0 py-3 text-center wow fadeIn">
            <h2 class="hh2"><strong class="text-white">Find your Domain Name Here</strong></h2>
        </div>
        <!--  -->
                ...
                <div class="row">
                    <div class="col-sm-8">
                        <section class="container-fluid py-3">
                            <div class="container-fluid px-0 mySlides w3-animate-left">
                                <section class="container-fluid border w3-section  border-light py-2 test_sec">
                                    <p>
                                        “One thing that stands out is wehostafrica’s culture of accountability. The people
                                        we deal with in operations are professionals.”
                                    </p>
                                    <h6><strong class="font-weight-bold text-dark">Adewale Micheal</strong></h6>
                                </section>
                                <!--  -->
                                <section class="container-fluid border w3-section  border-light py-2 test_sec">
                                    <p>
                                        “Our explosive worldwide growth continues–with wehostafrica’s superb infrastructure
                                        support, we are taking it to the next level.”
                                    </p>
                                    <h6><strong class="font-weight-bold text-dark">Njoku David</strong></h6>
                                </section>
                            </div>
                    ...
                    <!--  -->
                    <div class="col-sm-4">
                        <section class="container-fluid px-0 py-3 text-center w3-hide-small">
