...
@section('part-header')
    <div class="container wow fadeIn py-5" id="head_notez">
        <h1 class="hh2 text-primary pt-2 font-weight-bold text-shadow wow fadeIn">Shared Hosting
            Services</h1>
        <h6 class="wow fadeIn" data-wow-delay=".5s">We offer reliable shared hosting at an affordable price, Get this
            and
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <section class="container-fluid py-3 list_sec w3-section wow fadeIn" data-wow-delay="2s">
                            ...
                            <h6>
                                <small>Enjoy Unlimited Bandwith</small>
                            </h6>
                            <hr class="border-warning d-inline-block p-0 text-center" style="width: 50px;">
                            <div class="container-fluid w3-section px-0 pt-3 pb-3">
                                <h6 class="pb-1"><strong class="text-dark">Features</strong></h6>
                                   ...
                                   aria-controls="collapseOne">
                                    <div class="card py-2">
                                        ...
                                        <div id="ques1" class="collapse" role="tabpanel" aria-labelledby="headingOne"
                                            ...
                                            <div class="card-body">
                                                Shared web hosting service is a web hosting service where many websites
                                                reside on one web server connected to the internet. This is generally
                                                the
                                                most economical option for hosting, as the overall cost of server
                                                maintenance is shared over many customers.
                                            </div>
                                        </div>
                                    </div>
                                </a>
                                   ...
                                   aria-controls="collapseOne">
                                    <div class="card py-2">
                                        ...
                                        <div id="ques3" class="collapse" role="tabpanel" aria-labelledby="headingOne"
                                             data-parent="#accordion">
                                            <div class="card-body">
                                                <span class="text-danger">No</span>, you cannot host asp.net apps on
                                                shared
                                                hosting as it is Windows based and we only offer Linux based OS for
                                                shared
                                                hosting.
                                            </div>
                                        </div>
