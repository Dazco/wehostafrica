...
@section('part-header')
    <div class="container wow fadeIn py-5" id="head_notez">
        <h1 class="hh2 text-primary pt-2 font-weight-bold text-shadow wow fadeIn">Dedicated Server
            Hosting</h1>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <section class="container-fluid py-3 list_sec def w3-section wow fadeIn">
                            ...
                            <div class="container-fluid w3-section">
                                <a href="javascript:void(0)" class="btn btn-outline-warning"><b>Add to Cart</b></a>
                            </div>
                        </section>
                    </div>
                    <!--  -->
                                   ...
                                   aria-controls="collapseOne">
                                    <div class="card py-2">
                                        ...
                                        <div id="ques1" class="collapse" role="tabpanel" aria-labelledby="headingOne"
                                            ...
                                            <div class="card-body">
                                                Dedicated server is a computer in a network reserved for serving the
                                                needs
                                                of the network. Some networks require that one computer is set aside to
                                                manage communications between all the other computers. In the Web
                                                hosting
                                                business, a dedicated server is typically a rented service. The user
                                                rents
                                                the server, software and an Internet connection from the Web host.
                                            </div>
                                        </div>
                                    </div>
                                </a>
